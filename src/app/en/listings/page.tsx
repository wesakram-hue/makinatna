      ...
      {error ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {listings.map((item) => {
            ...
            const city = localizeText(locale, item.city_name_en, item.city_name_ar);
            const category = localizeText(locale, item.category_name_en, item.category_name_ar);
            ...
            return (
              ...
              >
                ...
                <div className="text-sm text-muted-foreground">
                  {t(locale, "listings.category")}: <BidiText>{category}</BidiText>
                </div>
                {price && (
